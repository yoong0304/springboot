...
import com.bed.dto.QMainItemDto;
import com.bed.entity.Item;
import com.bed.entity.QItem;
import com.bed.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    public void deleteByItemId(Long itemId) {
        String queryString = "DELETE FROM ItemImg i WHERE i.item.id = :itemId";
